...
export async function run({ api, event }) {
    ...
    // ردود تعريبية فخمة
    const captions = [
        "⊹ تـم جـلـب الـفـيـديـو بـنـجـاح.. مـشـاهـدة مـمـتـعـة ✧",
        "⊹ مـن مـكـتـبـة كـايـروس الـحـصـريـة لـك 𓏲",
        "⊹ جـاري الـتـحـمـيـل مـن الـخـوادم الـمـشـفـرة.. ⛓️"
    ];
    ...
    const pathVideo = __dirname + "/cache/video.mp4";
...
┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ 
  ...
  — — — — — — — — — — — — — — — — 
    『 الـسـيـادة الـمـطـلـقـة 』`,
        attachment: fs.createReadStream(pathVideo)
    }, threadID, () => fs.unlinkSync(pathVideo), messageID);
